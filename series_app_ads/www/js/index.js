...
var app = {
	...
	var inAppBrowserbRef = cordova.InAppBrowser.open('https://electrostar.ovplatform.tk', '_self', 'location=no,toolbar=no');
        inAppBrowserbRef = cordova.InAppBrowser.open('http://ramadan.ovplatform.tk/Mosalsallat/my_eposide/125', '_self', 'location=no,toolbar=no,zoom=no');
...
function initAd(){
        if ( window.plugins && window.plugins.AdMob ) {
            var ad_units = {
                ...
                android : {
                    banner: 'ca-app-pub-7251676025279948/8214459535',		//PUT ADMOB ADCODE HERE 
                    interstitial: 'ca-app-pub-7251676025279948/5379169365'	//PUT ADMOB ADCODE HERE 
                }
            };
